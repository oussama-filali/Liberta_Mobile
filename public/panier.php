...
if (empty($items)) {
        ...
        $content .= '<tr>
            ...
            <td>
                <form action="?page=panier" method="POST">
                    ...
                    <button type="submit" name="supprimer" class="text-red-600">Supprimer</button>
                </form>
            </td>
        </tr>';
    }
    ...
    <div class="mt-4 text-right">
        ...
        <button onclick="procederPaiement()" class="bg-red-vif text-white py-2 px-6 rounded mt-2">Payer avec Stripe</button>
    </div>';
}
$content .= '</section>';
?>