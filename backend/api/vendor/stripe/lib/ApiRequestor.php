...
class ApiRequestor
{
     ...
     * @param null|mixed $clientInfo client user agent information
     * @param null|array $appInfo information to identify a plugin that integrates Stripe using this library
     * @param 'v1'|'v2' $apiMode
     *
     * @return array
     */
    ...
    private function _prepareRequest($method, $url, $params, $headers, $apiMode)
    {
        ...
        if (\method_exists($httpClient, 'getUserAgentInfo')) {
            $clientUAInfo = $httpClient->getUserAgentInfo();
        }
